...
const QuestionPage9 = () => {
  ...
  // Save the answer to localStorage and navigate to the next question (easy/10)
  const handleSubmit = (e: React.FormEvent) => {
    e.preventDefault(); // Prevent the default form submission
    if (selectedAnswer) {
      localStorage.setItem('easy_9_answer', selectedAnswer); // Store answer in localStorage
      router.push('/token-trials/easy/10'); // Navigate to easy/10
    } else {
    ...
    <div className="flex items-center flex-col flex-grow pt-10">
      ...
      <div className="flex flex-col items-center bg-base-100 shadow-lg shadow-secondary border-8 border-secondary rounded-xl p-6 mb-8 w-full max-w-lg text-center">
        <h1 className="text-2xl font-bold mb-4">
          How does the Canada Revenue Agency (CRA) classify cryptocurrency for tax purposes?
        </h1>
