...
export default function E25() {
  ...
  const handleSubmit = (e) => {
    e.preventDefault();
    localStorage.setItem('e25Input', input);
    router.push('/blanca/Part_E/e26');
  };
    ...
    <div>
      <div className="max-w-2xl mx-auto mb-12">
        <h1 className="text-2xl font-semibold text-left">
          The law applicable to the offer to the public of crypto-assets
        </h1>
      </div>
