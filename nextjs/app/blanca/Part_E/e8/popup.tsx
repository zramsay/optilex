  ...
  return (
    <div className="fixed inset-0 flex items-center justify-center z-50">
      ...
      <div className="bg-white p-4 rounded shadow-md z-10 max-w-md mx-auto mt-20">
        <h2 className="text-lg font-semibold text-black">Outline the steps that will be taken if the minimum subscription goal is not achieved. Specify whether funds will be returned to investors and under what conditions.</h2>
