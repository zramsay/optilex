  ...
  return (
    <div className="fixed inset-0 flex items-center justify-center z-50">
      ...
      <div className="bg-white p-4 rounded shadow-md z-10 max-w-md mx-auto mt-20">
        <h2 className="text-lg font-semibold text-black">Specific reasons and uses of funds for the offer and admission to trading can vary significantly depending on the project's objectives, market conditions, and strategic considerations.</h2>
