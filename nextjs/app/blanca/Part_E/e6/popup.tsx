  ...
  return (
    <div className="fixed inset-0 flex items-center justify-center z-50">
      ...
      <div className="bg-white p-4 rounded shadow-md z-10 max-w-md mx-auto mt-20">
        <h2 className="text-lg font-semibold text-black">Provide a detailed breakdown of how the raised funds or crypto-assets will be allocated across different areas of the project (e.g., development, marketing, legal compliance, operational costs). This should align with the project’s overall strategic objectives.</h2>
