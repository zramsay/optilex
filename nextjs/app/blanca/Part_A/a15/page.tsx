...
export default function A15() {
  ...
  const handleSubmit = (e) => {
    e.preventDefault();
    localStorage.setItem('a15Input', input);
    router.push('/blanca/Part_A/a16');
  };
    ...
    <div>
      <div className="max-w-2xl mx-auto mb-12">
        <h1 className="text-2xl font-semibold text-left ">
          Provide a narrative description of your company's financial condition for the preceding three (3)
 years. </h1>
      </div>
