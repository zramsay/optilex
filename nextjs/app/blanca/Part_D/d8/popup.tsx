  ...
  return (
    <div className="fixed inset-0 flex items-center justify-center z-50">
      ...
      <div className="bg-white p-4 rounded shadow-md z-10 max-w-md mx-auto mt-20">
        <h2 className="text-lg font-semibold text-black">Clearly state the specific purposes for which the funds or crypto-assets collected are intended. This should cover all areas where funds will be directed, such as development, marketing, compliance, or operational costs. Describe the alignment of fund utilization with the overall objectives of the crypto-asset project.</h2>
