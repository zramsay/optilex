    ...
    <div className="fixed inset-0 flex items-center justify-center z-50">
      ...
      <div className="bg-white p-4 rounded shadow-md z-10 max-w-md mx-auto mt-20">
        ...
        <p className="text-black mt-4">
          MiCA standardizes crypto-asset regulations across the EU to ensure uniform rules and consumer protection. Citation: <em>"MiCA Regulation: Markets in Crypto-Assets."</em> {' '}
          <a
