  ...
  return (
    <div className="fixed inset-0 flex items-center justify-center z-50">
      ...
      <div className="bg-white p-4 rounded shadow-md z-10 max-w-md mx-auto mt-20">
        <h2 className="text-lg font-semibold text-black">The "Double-Spend" Problem</h2>
        <p className="text-black">{helpText}</p>
        <p className="text-black mt-4">
          The "double-spend" problem is solved by blockchain’s immutable ledger, similar to how adverse claims are handled in legal systems. Citation: <em>Nakamoto, Satoshi. "Bitcoin: A Peer-to-Peer Electronic Cash System."</em> {' '}
          <a
