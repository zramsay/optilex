    ...
    <div className="fixed inset-0 flex items-center justify-center z-50">
      ...
      <div className="bg-white p-4 rounded shadow-md z-10 max-w-md mx-auto mt-20">
        ...
        <p className="text-black">
          Cryptolaw refers to the evolving legal landscape that merges blockchain technology, regulatory compliance, and intelligence management. Citation: <em>Kilbride NG. Distributed Ledgers, Cryptography, and Smart Contracts.</em> In: Katz DM, Dolin R, Bommarito MJ, eds. <em>Legal Informatics.</em> Cambridge University Press; 2021:239-256.{' '}
          <a
