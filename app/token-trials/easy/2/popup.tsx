  ...
  return (
    <div className="fixed inset-0 flex items-center justify-center z-50">
      ...
      <div className="bg-white p-4 rounded shadow-md z-10 max-w-md mx-auto mt-20">
        <h2 className="text-lg font-semibold text-black">Decentralization in Blockchain</h2>
        <p className="text-black">{helpText}</p>
        <p className="text-black mt-4">
          Decentralization in blockchain distributes control among network participants, preventing undue influence and enhancing system integrity. Citation: <em>Kilbride NG. Distributed Ledgers, Cryptography, and Smart Contracts.</em> In: Katz DM, Dolin R, Bommarito MJ, eds. <em>Legal Informatics.</em> Cambridge University Press; 2021:239-256.{' '}
          <a
