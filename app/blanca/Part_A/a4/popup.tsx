  ...
  return (
    <div className="fixed inset-0 flex items-center justify-center z-50">
      ...
      <div className="bg-white p-4 rounded shadow-md z-10 max-w-md mx-auto mt-20">
        <h2 className="text-lg font-semibold text-black">This is the main operating office of a company, where the key management and executive team are typically based. The head office is usually where strategic decisions are made and where the central functions of the business are coordinated. It is often located where the company conducts a significant portion of its business activities, although this is not a legal requirement.
</h2>
