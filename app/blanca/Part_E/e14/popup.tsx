  ...
  return (
    <div className="fixed inset-0 flex items-center justify-center z-50">
      ...
      <div className="bg-white p-4 rounded shadow-md z-10 max-w-md mx-auto mt-20">
        <h2 className="text-lg font-semibold text-black">Clearly define the types of investors issuer aims to attract, alongside explaining the rationale behind these choices. Lay out any necessary legal and technical restrictions that ensure the project aligns with regulatory requirements and operational standards. </h2>
