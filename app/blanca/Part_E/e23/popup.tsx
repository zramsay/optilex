  ...
  return (
    <div className="fixed inset-0 flex items-center justify-center z-50">
      ...
      <div className="bg-white p-4 rounded shadow-md z-10 max-w-md mx-auto mt-20">
        <h2 className="text-lg font-semibold text-black">Expenses typically include legal and regulatory compliance expenses, marketing and promotional activities, technology and infrastructure costs, and fees paid to service providers such as auditors and advisors.</h2>
