  ...
  return (
    <div className="fixed inset-0 flex items-center justify-center z-50">
      ...
      <div className="bg-white p-4 rounded shadow-md z-10 max-w-md mx-auto mt-20">
        <h2 className="text-lg font-semibold text-black">Specify the exact amount of funds or the quantity of crypto-assets the project aims to raise through the public offer. If applicable, include the equivalent value in a widely recognized currency to provide clarity.</h2>
