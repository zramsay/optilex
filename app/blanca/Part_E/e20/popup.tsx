  ...
  return (
    <div className="fixed inset-0 flex items-center justify-center z-50">
      ...
      <div className="bg-white p-4 rounded shadow-md z-10 max-w-md mx-auto mt-20">
        <h2 className="text-lg font-semibold text-black">Specific description of technical requirements, i.e. wallets, etc., to ensure that all potential investors are adequately prepared to manage and use their crypto-assets.</h2>
