  ...
  return (
    <div className="fixed inset-0 flex items-center justify-center z-50">
      ...
      <div className="bg-white p-4 rounded shadow-md z-10 max-w-md mx-auto mt-20">
        <h2 className="text-lg font-semibold text-black">Clearly the maximum subscription goal for the entire offer. Explain the rationale behind this figure, such as project scalability needs or development costs.</h2>
