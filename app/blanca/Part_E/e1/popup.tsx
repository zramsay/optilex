  ...
  return (
    <div className="fixed inset-0 flex items-center justify-center z-50">
      ...
      <div className="bg-white p-4 rounded shadow-md z-10 max-w-md mx-auto mt-20">
        <h2 className="text-lg font-semibold text-black">Explicitly state if the white paper details an offer of crypto-assets to the public. This involves offering crypto-assets for purchase to a non-specific audience, which could be retail or general investors.</h2>
